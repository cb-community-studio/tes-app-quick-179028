...
import benefitsOpenEnrollmentFakerFactory from "./benefitsOpenEnrollmentFakerFactory";
...
const BenefitsOpenEnrollmentFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = benefitsOpenEnrollmentFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("benefitsOpenEnrollment").create(elem));
...
export default connect(null, mapDispatch)(BenefitsOpenEnrollmentFakerDialogComponent);

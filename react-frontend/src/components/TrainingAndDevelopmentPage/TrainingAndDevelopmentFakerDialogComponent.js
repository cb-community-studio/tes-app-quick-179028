...
import trainingAndDevelopmentFakerFactory from "./trainingAndDevelopmentFakerFactory";
...
const TrainingAndDevelopmentFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = trainingAndDevelopmentFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("trainingAndDevelopment").create(elem));
...
export default connect(null, mapDispatch)(TrainingAndDevelopmentFakerDialogComponent);

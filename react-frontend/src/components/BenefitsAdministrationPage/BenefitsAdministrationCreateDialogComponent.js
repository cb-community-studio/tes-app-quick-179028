...
const BenefitsAdministrationCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("benefitsAdministration").create(_data);
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info benefitsAdministration created successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="benefitsAdministration-create-dialog-component">
            <div>

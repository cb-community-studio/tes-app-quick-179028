...
const JobPostingCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("jobPosting").create(_data);
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info jobPosting created successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="jobPosting-create-dialog-component">
            <div>

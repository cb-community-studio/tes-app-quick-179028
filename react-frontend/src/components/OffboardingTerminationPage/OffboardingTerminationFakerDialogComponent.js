...
import offboardingTerminationFakerFactory from "./offboardingTerminationFakerFactory";
...
const OffboardingTerminationFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = offboardingTerminationFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("offboardingTermination").create(elem));
...
export default connect(null, mapDispatch)(OffboardingTerminationFakerDialogComponent);
